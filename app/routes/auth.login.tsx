    ...
    <div className="min-h-screen bg-[#FFF8E7] honeycomb-bg flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-6">
          ...
          <h1 className="font-fredoka text-[#3D2B1F] text-3xl">{config?.appName ?? "Spelling Bee Quest"}</h1>
          <p className="text-[#8B6A3E] font-nunito text-sm">{config?.tagline ?? "Sign in to save your progress!"}</p>
        </div>
        <LoginCard />
